    ...
    <section id="contact" className="py-20 bg-[#0f172a] text-white">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 mt-3">Get in touch for projects or collaborations</p>
        </div>

        {/* Contact Form */}
        <form className="bg-black p-8 rounded-2xl shadow-lg max-w-xl mx-auto flex flex-col gap-6">
          <input
            type="text"
